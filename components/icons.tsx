...
const iconProps = {
    className: "w-12 h-12 text-brand-accent group-hover:text-white transition-colors duration-300",
    fill: "none",
    viewBox: "0 0 24 24",
    stroke: "currentColor",
    strokeWidth: 1
...
export const DocumentReportIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 17v-2h6v2m-6-4h6m2-4h2a2 2 0 002-2v-4a2 2 0 00-2-2H7a2 2 0 00-2 2v4a2 2 0 002 2h2m0 0v6a2 2 0 002 2h2a2 2 0 002-2v-6m-7 1a1 1 0 11-2 0 1 1 0 012 0z" />
    </svg>
);
